...
SELECT e1.employee_id,e1.first_name,e1.manager_id,e1.salary FROM Employees e1 JOIN Employees e2 ON e1.Manager_Id = e2.employee_Id;
select * from employees;
#anotherSolution
select e1.employee_id, e1.first_name, e2.manager_id, e2.employee_id, e2.salary from employees e1, employees e2 
...
SELECT w.manager_id,count(*) as 'countofEmp'
...
Select *,if (salary BETWEEN 0 and 5000 , 'Group1' ,
if(salary BETWEEN 5001 and 10000, 'Group2', 'Group3')) as salary_group
from employees;    
